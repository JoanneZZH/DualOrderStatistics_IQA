...
from dataset import Tid2013DataSet, Kadid10KDataSet, KonIQ10KDataset
    ...
    for epoch in range(args.epochs):
        ...
        if gpu == 0 and epoch > 5:
            ...
            save_checkpoint({
                ...
                'best_res': best_res,
                'args': args,
            }, is_best, 'checkpoints/{}'.format(args.timestep + '_' + args.comment))
